...
const SelectContent = (props) => {
        return (
                <div>
                     ...
                     <div>
                        <div>
                           {/* <div>{JSON.stringify(props.storeData)}</div> */}
                           <span>금월매출 :</span>
                           <span> 
                                 {props.storeData.twoSales ? JSON.stringify(props.storeData.twoSales[0].total_sales) : '' }
                           </span>
                        </div>
                        <div>
                           <span>전월매출 :</span>
                           <span>
                                  {props.storeData.twoSales ? JSON.stringify(props.storeData.twoSales[1].total_sales) : '' }
                           </span>
                        </div>
                        <div>
                              <span>누적매출 :</span>
